...
async function setAllRates() {
  await setRates('https://rate.am', 'banks');
  await setRates('http://rate.am/am/armenian-dram-exchange-rates/exchange-points/cash', 'exchangesPoints');
  await setRates('http://rate.am/am/armenian-dram-exchange-rates/credit-organizations/cash', 'creditOrganizations');
  await setRates('http://rate.am/en/armenian-dram-exchange-rates/investment-organizations/non-cash', 'investmentOrganizations');
}
