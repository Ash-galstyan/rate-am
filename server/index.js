...
//           banks[res.id] = res.name;
//         });
//         con.query('SELECT * FROM rates WHERE date BETWEEN ' + startPreviousDayDate + ' AND ' + endPreviousDayDate, function (error, results, fields) {
//           if (error) throw error;
//           previousDayLastDate = results[results.length - 1].date;
//           con.query('SELECT * FROM rates WHERE date = ' + previousDayLastDate, function (error, results, fields) {
//             if (error) throw error;
